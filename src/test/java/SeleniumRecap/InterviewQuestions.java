...
public class InterviewQuestions {
    ...
    Disadvantages: -You cannot automate captcha,pictures,mobile application etc...
                   -There is no direct call(customer service) for support
                   -It only automate Web application(browsers)
                   -It does not have any system to generate report, so we use external resource(testing,cucumber,etc..)
    ...
    4-What is locator in Selenium? What type of locators do you use in your frameWork?
     ...
     The locators that I am using in my framework are:
        ...
        ->PartialLinkText ->find the element with "a" tagname and "partialText" of fullText
    ...
    6-Difference between driver.get() and driver.navigate() ?
        ...
        Navigate()-->It does not wait WebElements to be loaded from page.(it waits for only specific
                        elements that you are looking from page)
   ...
   8-What is Xpath and can you tell me about types of xpath? which one do you use the most?
    ...
    -->XPATH: Is one of the locators that I use in selenium to find the element.
       ...
       NOTE: I use definitely the relative xpath the most since it is more functional and effective to locate the elements
   ...
   9-How do you handle drop-downs? (static or dynamic drop down)
    ...
    In my project, I was handling the drop-downs with different ways: First
        ...
        -If the location has "SELECT" tagName" then --> I use Select Class
            ex:Select select = new Select(locationOfElement)
        -If the location does not have "SELECT" tagname then -->I can use
            -->Actions class methods like click or WebElements method click and choose option
                ->I would use SendKey() to choose the option.
   ...
   10-Can you tell me what do you know about Select class and it's methods?
    ...
    Select class is a way to handle Drop-downs:
        ...
        ->The WebElement must have Select tagValue
    ...
    12-How do you handle Stale Element Reference Exception?
        ...
        In my project, this exception is one of the hard ones that was giving me a headache?

            ->This exception happens when:
                -the dom is not update fast
    ...
    There are different types of pop-ups that I've faced during automation?
        ...
        2-HTML alert/pop-up: I just need to find the element and click on it (like OK or cancle Button)
   ...
   14-What do you know about iframe ? and how do you handle this in you automation?
        ...
        -->First switch your frame based on the value of WebElement:
            ...
            -driver.switchTo.defaultContent()->it will no matter what go to the main html directly
                                              no matter what how many time you switch your frame from parent to child
                                              with this method, it will directly skip all the parents and go to the maik html

        NOTE: if you do not handle this frame, you will get NOSUCHELEMENT exception
   ...
   15-What do you know about Actions class and can you tell me the methods you used the most during automation?
    ...
    Actions class basically does the functionality of mouse.I can say it is really useful in some cases during my
    automation to handle some elements. Some of the important methods are:

    IQ ***** --›ContextClick-->it right clicks on the WebElement  IQ: STAND FOR INTERVIEW QUESTION
    ...
    18-What is the difference between check-box and radio button?
        ...
        19-How do you handle multiple windows in automation?
    ...
    SoftAssert: -It is a class that have some methods to validate actual and expected data.
     ...
     23-Can you tell me about your Singleton Pattern design? -->Can you make the constructor private,static final?
        ...
        First of all, I appreciate for this question. since I like singleton logic because in the past
        I was working on my driver and getting lots of NULLPOINTER exception.
        With the help of Singleton, I centralize my driver which reduces the amount of exception I got which
        means it is more reliable and safe to use.
    ...
    24-What kind of Test annotation do you use in your project? Can you tell me What is the purpose of @Parameter usage?
        Please check the sublime --›It is explained in details recently

    25-What do you know about @DataProvide and why do you use it?
    Please check the sublime -->It is explained in details recently

    26-What do you know about Wait times and can you tell me the difference
        between Thread.sleep, implicitlyWait, explicitlyWait, FluentWait?
         Please check the Sublime -->It is explained in details recently
